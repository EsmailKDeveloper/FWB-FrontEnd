  ...
  return (
    <div className='w-full min-h-screen '>
        <section className='container mx-auto lg:w-[85%] py-10 px-10 md:px-0'>
            <h2 className='font-Shabnam-Medium font-bold text-2xl'>  دوره های آموزشی که بصورت حضوری وآنلاین برگذار میگردد </h2>
            <div className='grid grid-cols-12 py-5 mt-5 gap-4'>
                {course.map((item)=>(
                  <Link href={`/courses/${item.id}`} key={item.id} className='col-span-12 sm:col-span-6 md:col-span-4 shadow p-1   card_shadow rounded-sm'>
                      ...
                      <figcaption className='p-3'>
                          ...
                          <div className='my-2 flex gap-x-2.5'>
                              ...
                              <p className='font-Shabnam-Light'>👤 <span>0 شاگرد</span> </p>
                          </div>
